...
/**
 * Exception signalant que le nombre d'arguments dans une ligne du {@linkplain java.io.File fichier} est incorrect (différent de deux).
...
public class NombreArgumentIncorrectException extends Exception{
	...
	/**
	 * Exception signalant que le nombre d'arguments dans une ligne du {@link java.io.File fichier} est incorrect.
	 * @see ChargeurReseau#traiterLigne(String, Reseau)
